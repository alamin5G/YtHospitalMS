...
public class Main {
    ...
    public static void main(String[] args) {
        ...
        private static boolean checkDoctorAvailability ( int doctorId, String appointmentDate, Connection connection){
            String queryForCount = "SELECT COUNT(id) FROM appointments WHERE doctor_id = ? AND appointment_date = ?";
            try {
                PreparedStatement preparedStatement = connection.prepareStatement(queryForCount);
